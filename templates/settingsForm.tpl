{**
 * plugins/importexport/crossrefConference/templates/settingsForm.tpl
 *
...
<form class="pkp_form" id="crossrefSettingsForm" method="post" action="{url router=$smarty.const.ROUTE_COMPONENT op="manage" plugin="CrossrefConferenceExportPlugin" category="importexport" verb="save"}">
	{csrf}
	...
	{fbvFormArea id="crossrefSettingsFormArea"}
		...
		{/fbvFormSection}
		{fbvFormSection list="true"}
			{fbvElement type="checkbox" id="testMode" label="plugins.importexport.crossrefConference.settings.form.testMode.description" checked=$testMode|compare:true}
		{/fbvFormSection}
	{/fbvFormArea}
